    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
        <Card className="p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">You need to be signed in to create or join a party.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600">Play with friends or strangers</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="p-8 shadow-lg">
            ...
            <Button
              ...
              disabled={joinSessionMutation.isPending || !joinCode.trim()}
